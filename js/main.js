...
var positionCount;
var selectedSquare = null; // Added selectedSquare variable
...
function onSquareClick(square) {
    if (!selectedSquare) {
        ...
        if (move === null) {
            selectedSquare = null; // Reset selection on invalid move
            return;
        }
...
var config = {
    draggable: true, // Keep drag-and-drop functionality
    position: "start",
    pieceTheme: "https://chessboardjs.com/img/chesspieces/wikipedia/{piece}.png",
    onClick: onSquareClick, // Attach click event for click-to-move
